...
public final class EncryptRuleTest {
    ...
    public void assertNewInstanceWithAlgorithmProvidedEncryptRuleConfiguration() {
        ...
        EncryptTableRuleConfiguration tableConfig = new EncryptTableRuleConfiguration("t_encrypt", Collections.singletonList(encryptColumnConfig), false);
        ...
        assertThat(actual.isQueryWithCipherColumn("t_encrypt"), is(false));
    }
    ...
    private EncryptRuleConfiguration createEncryptRuleConfiguration() {
        ...
        EncryptTableRuleConfiguration tableConfig = new EncryptTableRuleConfiguration("t_encrypt", Arrays.asList(pwdColumnConfig, creditCardColumnConfig), false);
